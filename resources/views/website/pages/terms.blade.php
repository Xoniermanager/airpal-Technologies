                    ...
                    <div class="col-md-12">
                        <div class="terms-content">
                            ...
                            <div class="terms-text terms-list">
                                <p><i class="fas fa-circle-check"></i> At vero eos et accusamus et iusto odio
                                    dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti
                                    quos dolores et</p>
                                <p><i class="fas fa-circle-check"></i> Sed ut perspiciatis unde omnis iste natus error
                                    sit voluptatem accusantium doloremque laudantium,</p>
                                <p><i class="fas fa-circle-check"></i> Nemo enim ipsam voluptatem quia voluptas sit
