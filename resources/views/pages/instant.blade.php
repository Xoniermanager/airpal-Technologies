            ...
            <div class="container">
                ...
                <div class="owl-carousel our-doctors owl-theme aos" data-aos="fade-up">
                        ...
                        <div class="our-doctors-card">
                            ...
                            <div class="doctors-body">
                                ...
                                <div class="row row-sm">
                                    <div class="col-6">
                                        <a href="{{ route('doctor_profile.index') }}" class="btn view-btn" tabindex="0">View Profile</a>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{ route('appointment.index') }}" class="btn book-btn" tabindex="0">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="our-doctors-card">
                            <div class="doctors-header">
                                <a href="#"><img src="{{URL::asset('assets/img/doctors/doctor-04.jpg')}}" alt="Deborah Angel"
                                        class="img-fluid"></a>
                    ...
                    <div class="item">
                        <div class="our-doctors-card">
                            <div class="doctors-header">
                                <a href="#"><img src="{{URL::asset('assets/img/doctors/doctor-03.jpg')}}" alt="Sofia Brient"
                                        class="img-fluid"></a>
                    ...
                    <div class="item">
                        <div class="our-doctors-card">
                            <div class="doctors-header">
                                <a href="#"><img src="{{URL::asset('assets/img/doctors/doctor-02.jpg')}}" alt="Darren Elder"
                                        class="img-fluid"></a>
