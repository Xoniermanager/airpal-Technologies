        ...
        <div class="appointment-wrap appointment-detail-card">
            <ul>
                <li>
                    <div class="patinet-information">
                        <a href="#">
                            <img src="{{ $appointment->user->image_url }}" alt="">
                        </a>
                ...
                <li class="appointment-action">
                    <div class="detail-badge-info">
                        <span
                            class="badge bg-grey me-2">{{ $appointment->user->bookedAppointments->count() < 2 ? 'New Patient' : '' }}</span>
            ...
            <ul class="detail-card-bottom-info">
                <li>
                    ...
                    <span>{{ date('j M Y', strtotime($appointment->booking_date)) ?? '' }} -
                        {{ date('h:i A', strtotime($appointment->slot_start_time)) ?? '' }}</span>
                </li>
                {{-- <li>
