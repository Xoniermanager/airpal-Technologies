...
class DoctorAppointmentController extends Controller
{
    ...
    public function allCompleteAppointment()
    {
        try {
            $bookings = $this->bookingServices->allCompleteAppointmentByDoctorId(auth::id());
            return view('doctor.appointments.complete-appointment',compact('bookings'));
        } catch (\Exception $e) {
            return  $e->getMessage();
        }
    }
