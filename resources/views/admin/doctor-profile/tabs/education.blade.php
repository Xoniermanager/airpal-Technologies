...
<div class="tab-pane fade" id="education_tab">
    <div class="dashboard-header border-0 mb-0">
        ...
        <ul>
            <li>
                <a class="btn btn-primary prime-btn add-educations" onclick="addEducation({{$userEducationCount ?? '' }})">Add New
                    Education</a>
            </li>
        </ul>
    </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <div class="form-icon">
                                                <input type="text"
                                                    class="form-control flat-picker" name="education[{{$key}}][start_date]" autocomplete="off" value="{{$singleEducationDetail->start_date ?? " "}}">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <div class="form-icon">
                                                <input type="text"
                                                    class="form-control flat-picker" name="education[{{$key}}][end_date]" autocomplete="off" value="{{$singleEducationDetail->end_date ?? " "}}">
