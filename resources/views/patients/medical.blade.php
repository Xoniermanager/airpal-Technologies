                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="add-med-record">
                                    <a href="#add-med-record" class="btn btn-primary prime-btn"
                                        data-bs-toggle="modal">Add Medical Details</a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a class="text-blue-600" href="javascript:void(0);"
                                                            ...
                                                            data-bs-target="#med-detail">#MD-123</a></td>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="{{ route('patients.patient-dependant.index') }}">Hendrita
                                                                Kearns</a>
                                                        </h2>
                                                    </td>
                                                    <td>23.5</td>
