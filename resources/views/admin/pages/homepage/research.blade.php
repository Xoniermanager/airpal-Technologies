                ...
                <div class="setting-card">
                    <div class="add-info membership-infos">
                        <div class="row membership-content">
                            ...
                            <div class="col-lg-12">
                                @php
                                    $research_title = isset($sections['research']->getContent[$i]['title'])
                            ...
                            <div class="col-lg-12">
                                @php
                                    $research_content = isset($sections['research']->getContent[$i]['content'])
