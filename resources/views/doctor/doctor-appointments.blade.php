                            ...
                            <ul class="header-list-btns">
                                ...
                                <li>
                                    <div class="view-icons">
                                        <a href="{{ route('doctor.doctor-appointments.index') }}"><i class="fa-solid fa-list"></i></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="view-icons">
                                        <a href="{{ route('doctor.doctor-appointments.index') }}" class="active"><i
                                            ...
                                            <ul>
                                                    ...
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0001</p>
                                                                <h6><a
                                                                        href="{{ route('doctor.doctor-appointments.index') }}">Adrian</a>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="appointment-action">
                                                    ...
                                                    <div class="appointment-start">
                                                        <a href="{{ route('doctor.doctor-appointments.index') }}" class="start-link">Start
                                                            Now</a>
                                                    </div>
                                                </li>
                                            </ul>
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0002</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Kelly
                                                                        Stevens</a><span
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0003</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Samuel
                                                                        James</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0004</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Catherine
                                                                        Gracey</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0005</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Robert
                                                                        Miller</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0006</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Anderea
                                                                        Kearns</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0007</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Peter
                                                                        Anderson</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0008</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Emily
                                                                        Musick</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                                ...
                                                <li>
                                                    <div class="appointment-grid-head">
                                                        <div class="patinet-information">
                                                            ...
                                                            <div class="patient-info">
                                                                <p>#Apt0009</p>
                                                                <h6><a href="{{ route('doctor.doctor-appointments.index') }}">Darrell
                                                                        Tan</a></h6>
                                                            </div>
                                                        </div>
                                                        <div class="grid-user-msg">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-12 d-flex">
                                        <div class="appointment-wrap appointment-grid-wrap">
                                            <ul>
                                                ...
                                                <li class="appointment-detail-btn">
                                                    <a href="{{ route('doctor.doctor-appointment-details.index') }}"
                                                        class="start-link w-100">View Details</a>
                                                </li>
                                            </ul>
                                        </div>
