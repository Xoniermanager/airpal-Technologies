                ...
                <div class="col-6">
                    <div class="mb-3">
                        <label class="mb-2">Slot Duration <span style="color: red">* </span>(in
                            minutes)</label>
                        <input type="number" name="slot_duration" class="form-control" value="{{ $doctorAppointmentConfigDetails->slot_duration ?? '' }}">
                    </div>
                </div>
            </div>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        <label class="mb-2">CleanUp Interval(Break between meetings) <span>(in
                                minutes)</span></label>
                        <input type="number" name="cleanup_interval" class="form-control"  value="{{ $doctorAppointmentConfigDetails->slot_duration ?? ''}}" >
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="number" name="start_month" class="form-control" value="{{ $doctorAppointmentConfigDetails->start_month ?? '' }}"
                           >
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="mb-3" id="slots-div">
                        ...
                        <input type="number" name="end_month" class="form-control" value="{{ $doctorAppointmentConfigDetails->end_month ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="date" name="start_slots_from_date" class="form-control" value="{{ $doctorAppointmentConfigDetails->start_slots_from_date ?? '' }}"
                            >
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="mb-3" id="slots-div">
                        ...
                        <input type="date" name="stop_slots_date" class="form-control" value="{{ $doctorAppointmentConfigDetails->stop_slots_date ?? '' }}">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3" id="slots-div">
                        ...
                        <input type="number" name="slots_in_advance" class="form-control" value="{{ $doctorAppointmentConfigDetails->slots_in_advance ?? '' }}" >
                    </div>
                </div>
            </div>
