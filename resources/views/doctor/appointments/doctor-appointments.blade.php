                            ...
                            <ul class="header-list-btns">
                                ...
                                <li>
                                    <div class="view-icons">
                                        <a href="{{ route('doctor.appointments.index') }}"><i class="fa-solid fa-list"></i></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="view-icons">
                                        <a href="{{ route('doctor.appointments.index') }}" class="active"><i
                                ...
                                <ul class="nav nav-pills inner-tab " id="pills-tab" role="tablist">
                                    <ul class="nav nav-pills inner-tab" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="today" type="button"  onclick="filter('all',{{ $userId}},this)">All<span>{{ $doctorTotalAppointmentCounter }}</span></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="today" type="button"  onclick="filter('today',{{ $userId}},this)">Today<span>{{ $todayBookingCounter }}</span></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="upcoming" type="button" onclick="filter('upcoming',{{ $userId}},this)">Upcoming<span>{{ $getUpComingAppointmentCounter }}</span></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="cancelled" type="button" onclick="filter('canceled',{{ $userId}},this)">Cancelled<span>{{ $getAllCanceledAppointments}} </span></button>
                                        </li>
                                        {{-- <li class="nav-item" role="presentation">
                                    ...
                                    {{-- <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="today" data-bs-toggle="pill"
                                        type="button" >Today<span>21</span></button>
                                        <input type="hidden"  >
                                    </li> --}}
                                    {{-- <li class="nav-item" role="presentation">
...
<script>
    function filter(key, userId,element){
