...
<img src="{{URL::asset('assets/img/doctors/doctor-13.jpg')}}" class="img-fluid" alt="John Doe">
</a>
...
<h4 class="doc-name">
<a href="{{ route('doctor_profile.index') }}">Dr.John Doe</a>
...
<li><i class="feather-dollar-sign available-icon"></i> $1500 <i class="feather-info available-info-icon"></i></li>
</ul>
</div>
<div class="clinic-booking book-appoint">
    <a class="btn btn-primary" href="{{ route('appointment.index') }}">Book Appointment</a>
    <a class="btn btn-primary-light" href="{{ route('appointment.index') }}">Book Online Consultation</a>
</div>
</div>
</div>
</div>
...
<div class="doctor-img">
<a href="{{ route('doctor_profile.index') }}">
<img src="{{URL::asset('assets/img/doctors/doctor-14.jpg')}}" class="img-fluid" alt="Darren Elder">
</a>
<div class="favourite-btn">
<a href="javascript:void(0)" class="favourite-icon">
<i class="fas fa-heart"></i>
...
<li>
<i class="feather-clock available-icon"></i>
<span class="available-date available-tomorrow">Available Tomorrow</span>
</li>
<li><i class="feather-thumbs-up available-icon"></i> 90% <span class="votes">(380 Votes)</span></li>
<li><i class="feather-dollar-sign available-icon"></i> $2800 <i class="feather-info available-info-icon"></i></li>
</ul>
</div>
<div class="clinic-booking book-appoint">
<a class="btn btn-primary" href="{{ route('appointment.index') }}">Book Appointment</a>
...
<div class="doctor-img">
<a href="{{ route('doctor_profile.index') }}">
<img src="{{URL::asset('assets/img/doctors/doctor-15.jpg')}}" class="img-fluid" alt="Sofia Brient">
</a>
<div class="favourite-btn">
<a href="javascript:void(0)" class="favourite-icon">
<i class="fas fa-heart"></i>
...
<div class="doctor-img">
<a href="{{ route('doctor_profile.index') }}">
<img src="{{URL::asset('assets/img/doctors/doctor-16.jpg')}}" class="img-fluid" alt="Johny Rita">
</a>
<div class="favourite-btn">
<a href="javascript:void(0)" class="favourite-icon">
<i class="fas fa-heart"></i>
...
<div class="doc-info-cont">
<h4 class="doc-name">
<a href="{{ route('doctor_profile.index') }}">Dr. Johny Rita</a>
<i class="fas fa-circle-check"></i>
</h4>
<p class="doc-speciality">MBBS, Dentist</p>
<div class="clinic-details">
...
<div class="doctor-img">
<a href="{{ route('doctor_profile.index') }}">
<img src="{{URL::asset('assets/img/doctors/doctor-17.jpg')}}" class="img-fluid" alt="Deborah Angel">
</a>
<div class="favourite-btn">
<a href="javascript:void(0)" class="favourite-icon">
<i class="fas fa-heart"></i>
...
<div class="doc-info-cont">
<h4 class="doc-name">
<a href="{{ route('doctor_profile.index') }}">Dr. Deborah Angel</a>
<i class="fas fa-circle-check"></i>
</h4>
<p class="doc-speciality">MBBS, Dentist</p>
<div class="clinic-details">
