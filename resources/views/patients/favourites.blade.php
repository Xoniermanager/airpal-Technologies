                                    ...
                                    <div class="fav-head">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <ul class="available-info">
                                                <li>
                                                    <span><i class="fa-solid fa-calendar-day"></i></span>Next
                                                    Availability : 23 Mar 2024
                                                </li>
                                                <li>
                                    ...
                                    <div class="fav-head">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <ul class="available-info">
                                                <li>
                                                    <span><i class="fa-solid fa-calendar-day"></i></span>Next
                                                    Availability : 27 Mar 2024
                                                </li>
                                                <li>
                                                    <span><i class="fas fa-map-marker-alt"></i></span>Location : Los
                                                    Angeles, USA
                                                </li>
                                            </ul>
                                            <div class="last-book">
                                    ...
                                    <div class="fav-head">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <ul class="available-info">
                                                <li>
                                                    <span><i class="fa-solid fa-calendar-day"></i></span>Next
                                                    Availability : 10 May 2024
                                                </li>
                                                <li>
                                                    <span><i class="fas fa-map-marker-alt"></i></span>Location : Las
                                                    Vegas, USA
                                                </li>
                                            </ul>
                                            <div class="last-book">
                                ...
                                <div class="profile-widget patient-favour">
                                    <div class="fav-head">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <p class="speciality">BSND - Bachelor of Science in Nutrition and
                                                Dieteticsantology, BDS</p>
                                            <div class="rating">
                                                <i class="fas fa-star filled"></i>
                                                <i class="fas fa-star filled"></i>
                                                <i class="fas fa-star filled"></i>
                                            ...
                                            <ul class="available-info">
                                                <li>
                                                    <span><i class="fa-solid fa-calendar-day"></i></span>Next
                                                    Availability : 24 May 2024
                                                </li>
                                                <li>
                                                    <span><i class="fas fa-map-marker-alt"></i></span>Location : Miami,
                                                    USA
                                                </li>
                                            </ul>
                                            <div class="last-book">
                                    ...
                                    <div class="fav-head">
                                        ...
                                        <div class="pro-content">
                                            ...
                                            <ul class="available-info">
                                                <li>
                                                    <span><i class="fa-solid fa-calendar-day"></i></span>Next
                                                    Availability : 13 Jun 2024
                                                </li>
                                                <li>
                                                    <span><i class="fas fa-map-marker-alt"></i></span>Location : San
                                                    Jose, USA
                                                </li>
                                            </ul>
                                            <div class="last-book">
