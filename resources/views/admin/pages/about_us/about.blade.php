            ...
            <div class="content container-fluid">
                <div class="page-header">
                    ...
                    <div class="row">
                        ...
                        {{-- How it Work Section --}}
                        <div class="col-sm-12">
                            <h3 class="page-title">Key Features</h3>
                            <div class="card">
                                <form id="save_about_us_header_banner_detail" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @include('admin.pages.about_us.key_features')
                                </form>
                            </div>
                        </div>
                ...
                $('form').each(function() {
                    jQuery(this).validate({
                        ...
                        submitHandler: function(form) {
                            ...
                            $.ajax({
                                url: "<?= route('admin.store.about_us.page.detail') ?>",
                                type: 'post',
                                data: formData,
                                dataType: 'json',
                                processData: false,
