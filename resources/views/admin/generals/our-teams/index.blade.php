                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-7 col-auto">
                            <h3 class="page-title">Our Teams</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-sm-5 col">
                            <a href="{{route('admin.show.our.team.form')}}"  class="btn btn-primary float-end mt-2">Add</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                @include('admin.generals.our-teams.our_team_list')
                            </div>
                        </div>
                    </div>
                </div>
