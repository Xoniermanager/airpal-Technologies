        ...
        <table class="table table-hover table-center mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    @if($slot->user->doctorExceptionDays->isNotEmpty())
                    {{  $slot->user->doctorExceptionDays->pluck('exceptionDay.name')->implode(', ') }}
                        @else
                            No exception days
                        @endif
                    </td>
                    ...
                    <td>
                        <div class="actions">
                            <a class="btn btn-sm bg-success-light" data-id ="{{$slot['name']}}" data-bs-toggle="modal"href="#edit_slot" onclick="edit_slot('{{ $slot }}', '{{ $slot->user->doctorExceptionDays->pluck('exception_days_id')}}')">
