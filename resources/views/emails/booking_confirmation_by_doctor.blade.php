									...
									<td align="center" valign="top">
										...
										<table border="0" cellpadding="0" cellspacing="0"
											...
											<tbody>
												...
												<tr>
													<td align="center"><img src="{{ asset('assets/img/logo.png') }}" style="width:150px;padding:10px;" alt=""> </td>
												</tr>
																...
																<tr>
																	<td align="center" valign="top"
																		...
																		<p style="color:#555; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:26px; text-transform:none;margin: 0; text-align: left;padding-top:20px;">
																			Good news! The doctor has successfully confirmed your appointment. Please review your booking information below.																		</p>
																	</td>
																</tr>
																		...
																		<table style="width: 100%;">
																			...
																			<tr>
																				<td style="padding-bottom: 10px;" width="40%"> 
																					 ...
																					 font-size: 16px;
																					 text-align: left;
																					 line-height: 25px;color:#555;">Status</p>
																				</td>
																				<td style="padding-bottom: 10px;" width="60%">
																					<p style="font-family: 'Poppins';margin: 0;
																					font-size: 16px;
																					text-align: left;
																					line-height: 25px;">Confirmed</p>
																				</td>
																			</tr>
																		</table>
																		</td>
