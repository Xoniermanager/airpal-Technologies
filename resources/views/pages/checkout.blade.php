...
<label for="terms_accept">I have read and accept <a href="{{ route('term.index') }}">Terms &amp; Conditions</a></label>
</div>
</div>
...
<a href="{{ route('doctor_profile.index') }}" class="booking-doc-img">
<img src="{{URL::asset('assets/img/doctors/doctor-thumb-02.jpg')}}" alt="User Image">
</a>
<div class="booking-info">
<h4><a href="{{ route('doctor_profile.index') }}">Dr. Darren Elder</a></h4>
<div class="rating">
