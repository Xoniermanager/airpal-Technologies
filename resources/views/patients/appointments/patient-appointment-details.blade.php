                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="dashboard-header">
                            <div class="header-back">
                                <a href="appointments.html" class="back-arrow"><i
                                                ...
                                                <div class="mail-info-patient">
                                                    <ul>
                                                        <li><i class="fa-solid fa-envelope"></i><a href="#"
                                                                class="__cf_email__"
                                                                data-cfemail="3a5f5e5b5653547a5f425b574a565f14595557">[email&#160;protected]</a>
                                                        </li>
                                            ...
                                            <div class="patient-info">
                                                ...
                                                <div class="mail-info-patient">
                                                    <ul>
                                                        <li><i class="fa-solid fa-envelope"></i><a href="#"
                                                                class="__cf_email__"
                                                                data-cfemail="cfaaabaea3a6a18faab7aea2bfa3aae1aca0a2">[email&#160;protected]</a>
                                                        </li>
                                                        <li><i class="fa-solid fa-phone"></i>1234567890</li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="patient-info">
                                                ...
                                                <div class="mail-info-patient">
                                                    <ul>
                                                        <li><i class="fa-solid fa-envelope"></i><a href="#"
                                                                class="__cf_email__"
                                                                data-cfemail="6f0a0b0e0306012f0a170e021f030a410c0002">[email&#160;protected]</a>
                                                        </li>
                                                        <li><i class="fa-solid fa-phone"></i>1234567890</li>
                                                    </ul>
                                                </div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mail-info-patient">
                                            <ul>
                                                <li><i class="fa-solid fa-envelope"></i><a href="#"
                                                        class="__cf_email__"
                                                        data-cfemail="89fae1e8e7fde8c9ecf1e8e4f9e5eca7eae6e4">[email&#160;protected]</a>
                                                </li>
                                                <li><i class="fa-solid fa-phone"></i> 1234567890</li>
                                            </ul>
                                        </li>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mail-info-patient">
                                            <ul>
                                                <li><i class="fa-solid fa-envelope"></i><a href="#"
                                                        class="__cf_email__"
                                                        data-cfemail="b1dbded9dff1d4c9d0dcc1ddd49fd2dedc">[email&#160;protected]</a>
                                                </li>
