...
padding: 24px;">
  ...
  <div style="width:100%;text-align: center;">
    ...
    <div style="width:100%;text-align: center;">
      ...
      font-size: 15px;
      padding: 8px;
      margin-top: 4px;">Thank you for your email, we will contact you soon.</p>

   </div>
   <div style="width:100%;text-align: center; margin-bottom: 10px;">
    
    <a href="{{ route('home.index') }}" style=" background-color: #054cc4;
    color: #fff;
    font-size: 15px;
    border-radius: 5px;
    padding: 10px;
    text-decoration: none;
    margin-top: 4px;">Redirect to Homepage</a>
