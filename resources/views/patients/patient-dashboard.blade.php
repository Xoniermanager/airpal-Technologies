                                            ...
                                            <div class="apponiment-dates">
                                                ...
                                                <div class="appointment-dash-card">
                                                    <div class="doctor-fav-list">
                                                        <div class="doctor-info-profile">
                                                            <a href="#" class="table-avatar">
                                                                <img src="../assets/img/doctors/doctor-17.jpg"
                                                                    alt="Img">
                                                            </a>
                                                            <div class="doctor-name-info">
                                                ...
                                                <ul class="nav" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link active" href="#" data-bs-toggle="tab"
                                                            data-bs-target="#heart-rate" aria-selected="false"
                                                            role="tab" tabindex="-1">Heart Rate</a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                            ...
                                            <div class="past-appointments-slider owl-carousel">
                                                <div class="appointment-dash-card past-appointment">
                                                    <div class="appointment-date-info">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <span><i class="fa-solid fa-clock"></i></span>Time :
                                                                04:00 PM - 04:30 PM (30 Min)
                                                            </li>
                                                            <li>
                                                                <span><i
                                                                        class="fa-solid fa-location-dot"></i></span>Newyork,
                                                                United States
                                                            </li>
                                                        </ul>
                                                    </div>
                                                            ...
                                                            <table class="table table-hover table-center mb-0">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <span
                                                                                class="badge badge-success-bg">Normal</span>
                                                                        </td>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <a href="#"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="text-blue-600"><a
                                                                                href="javascript:void(0);">#MR-123</a>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-blue-600"><a
                                                                                href="javascript:void(0);">#MR-124</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript:void(0);"
                                                                                class="lab-icon">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-blue-600"><a
                                                                                href="javascript:void(0);">#MR-126</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript:void(0);"
                                                                                class="lab-icon">
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-blue-600"><a
                                                                                href="javascript:void(0);">#MR-127</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="javascript:void(0);"
                                                                                class="lab-icon">
